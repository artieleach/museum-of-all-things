...
func emit_player_joined(peer_id: int, player_name: String):
	emit_signal("player_joined", peer_id, player_name)

func emit_player_left(peer_id: int):
	emit_signal("player_left", peer_id)

func emit_multiplayer_started():
	emit_signal("multiplayer_started")

func emit_multiplayer_ended():
	emit_signal("multiplayer_ended")

func emit_skin_selected(url: String, texture: ImageTexture):
	emit_signal("skin_selected", url, texture)
